                    ...
                    private Result WriteArgs()
					{
						...
						while (SubToolGeneralLimit > 0)
						{
							do
							{
								...
								Main.ProcessInstance.WriteBytes((IntPtr)(AllocateStart + GeneratedOffsets.FUNCTIONPTR_Sleep), BitConverter.GetBytes(_Sleep));
								Main.ProcessInstance.WriteBytes((IntPtr)(AllocateStart + GeneratedOffsets.FUNCTIONPTR_GetModuleHandleA), BitConverter.GetBytes(_GetModuleHandleA));
								Main.ProcessInstance.WriteBytes((IntPtr)(AllocateStart + GeneratedOffsets.FUNCTIONPTR_GetProcAddress), BitConverter.GetBytes(_GetProcAddress));

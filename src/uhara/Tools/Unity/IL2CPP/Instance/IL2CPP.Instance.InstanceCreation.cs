        ...
        public partial class IL2CPP
        {
            public partial class Instance
            {
                public class InstanceCreation
                {
                    ...
                    private readonly Dictionary<string, ulong> BaseCache = [];
                        ...
                        try
                        {
                            while (timeLimit > 0)
                            {
                                do
                                {
                                    ...
                                    ulong retAddress = TMemory.GetFunctionReturn(Main.ProcessInstance, il2cpp_object_new);
                    ...
                    private byte[] FixCall(byte[] bytes, ulong originalAddress)
                    {
                        ...
                        return [.. result.SelectMany(self => self)];
                    }
                    #endregion
                }
            }

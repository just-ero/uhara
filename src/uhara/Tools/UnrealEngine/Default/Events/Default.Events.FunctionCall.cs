    ...
    public partial class UnrealEngine
    {
        public partial class Default
        {
            public partial class Events
            {
                ...
                {
                    #region VARIABLES
                    private readonly string SubToolID = "cjuvgtrc";
                    ...
                    public static class ArgStruct
                    {
                        ...
                        public static Element FunctionNameSearchType = new(offset: 8, size: 2);
                        public static Element OutputOffset = new(offset: 10, size: 8);
                        public static Element ClassNamePtr = new(offset: 18, size: 8);
                        public static Element ObjectNamePtr = new(offset: 26, size: 8);
                        public static Element FunctionNamePtr = new(offset: 34, size: 8);
                        public static Element Instances = new(offset: 42, size: 2);
                        public static Element End = new(offset: 44, size: 0);
                    }
                    ...
                    #endregion
                    #region ADD_ARGUMENT
                    public nint AddArgument(short argType, string className, string objectName, string functionName, short instances)
                    {
                        do
                        {
                            if (!Initiate())
                            ...
                            // check wildcards for string comparison
                            {
                                ...
                                _functionNameSearchType = functionName switch
                                {
                                    null => SearchTypes.None,
                                    ['*', .., '*'] => SearchTypes.Contains,
                                    ['*', ..] => SearchTypes.EndsWith,
                            ...
                            // create string pointers
                            {
                                ...
                                Main.ProcessInstance.WriteBytes((nint)AddressInterfaceData, functionNameBytes);
                        ...
                        try
                        {
                            do
                            {
                                    ...
                                    if (ToolsShared.ToolData.UnrealEngine.F_UObjectProcessEvent == 0)
                                    {
                                        if (false)
                                            TUtils.Print(
                                                ...
                                                $"Couldn't find ProcessEvent: {success}");
                                        break;
                                    }

                                    Main.SetProcessCache(SubToolID, "F_UObjectProcessEvent", $"0x{ToolsShared.ToolData.UnrealEngine.F_UObjectProcessEvent:X}");
                                }
...

                                {
                                    ...
                                    Main.SetProcessCache(SubToolID, "D_FNamePoolAddress", $"0x{ToolsShared.ToolData.UnrealEngine.D_FNamePoolAddress:X}");
                                }
